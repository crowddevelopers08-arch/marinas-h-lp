...
const HEADERS = ['Timestamp', 'Form Name', 'Source', 'Name', 'Phone', 'Email', 'Condition', 'URL', 'Payment ID', 'Payment Status', 'TeleCRM'];
...
function normalizeSubmission(body: Record<string, unknown>): SubmissionBody {
  return {
    formName: toText(body.formName) || 'Hernia Consultation Booking Form',
    ...
    paymentId: toText(body.paymentId),
